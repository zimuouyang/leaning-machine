...
public class LanguageActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        list.add(new App(R.mipmap.xue_xi_qiang_guo, getString(R.string.xue_xi_qiang_guo), getString(R.string.package_name_xue_xi_qiang_guo), getString(R.string.xue_xi_qiang_guo_des)));
